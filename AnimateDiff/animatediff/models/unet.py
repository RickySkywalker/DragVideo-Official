...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def from_pretrained_2d(cls, pretrained_model_name_or_path, unet_additional_kwargs={}, **kwargs):
        ...
        cls._get_model_file = _get_model_file
    ...
    def set_attn_processor(self, processor: Union[AttentionProcessor, Dict[str, AttentionProcessor]]):
        ...
        def fn_recursive_attn_processor(name: str, module: torch.nn.Module, processor):
            ...
            for sub_name, child in module.named_children():
                # print(f"curr full name: {name}.{sub_name}")
    ...
    def load_attn_procs(self, pretrained_model_name_or_path_or_dict, **kwargs):
        state_dict = torch.load(pretrained_model_name_or_path_or_dict, map_location="cpu")
        attn_processors = {}
        ...
        if is_lora:
            ...
            raise ValueError(f"{pretrained_model_name_or_path_or_dict} does not seem to be in the correct format expected by LoRA training.")
        print("the data type of attn_processors: ", type(attn_processors))
